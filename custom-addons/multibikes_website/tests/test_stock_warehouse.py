...
class TestStockWarehouse(MultibikesWebsiteConfigTestCommon):
    ...
    def test_is_excluded_from_availability_field(self):
        ...
        self.assertFalse(self.main_warehouse.is_excluded_from_availability, 
                        "L'entrepôt principal ne devrait pas être exclu par défaut")
        self.assertFalse(self.secondary_warehouse.is_excluded_from_availability, 
                        "L'entrepôt secondaire ne devrait pas être exclu par défaut")
        self.assertTrue(self.excluded_warehouse.is_excluded_from_availability, 
    ...
    def test_modify_is_excluded_from_availability(self):
        ...
        self.assertTrue(self.main_warehouse.is_excluded_from_availability, 
                       "L'entrepôt principal devrait maintenant être exclu")
        self.assertFalse(self.excluded_warehouse.is_excluded_from_availability, 
    ...
    def test_impact_on_product_availability(self):
        ...
        self.assertTrue(
            initial_availabilities[0]['quantity_available'] > availabilities_after_exclusion[0]['quantity_available'],
        ...
        actual_diff = initial_availabilities[0]['quantity_available'] - availabilities_after_exclusion[0]['quantity_available']
    ...
    def test_warehouse_exclusion_with_specific_warehouse(self):
        ...
        self.assertEqual(main_warehouse_availabilities[0]['quantity_available'], expected_qty,
        ...
        main_warehouse_availabilities_after_exclusion = self.product._get_availabilities(
            start_date, end_date, warehouse_id=self.main_warehouse.id
        )
        
        # La quantité disponible devrait rester inchangée
        self.assertEqual(main_warehouse_availabilities_after_exclusion[0]['quantity_available'], expected_qty,
