...
class ProductTemplate(models.Model):
    ...
    caution = fields.Monetary(string='Caution', currency_field='currency_id', help="Montant de la caution à payer pour la location de ce produit.")
    
    # Champ pour la valeur en cas de vol
    value_in_case_of_theft = fields.Monetary(string='Valeur en cas de vol', currency_field='currency_id', help="Valeur du produit en cas de vol.")
