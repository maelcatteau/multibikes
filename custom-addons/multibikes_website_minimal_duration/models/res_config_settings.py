...
class ResCompany(models.Model):
    ...
    mb_renting_period2_end_date = fields.Date(string="Date fin période 2", default=lambda self: fields.Date.today().replace(month=6, day=30))
    mb_renting_period2_minimal_time_duration = fields.Integer(string="Durée minimale période 2", default=2)
    ...
    mb_renting_period3_start_date = fields.Date(string="Date début période 3", default=lambda self: fields.Date.today().replace(month=7, day=1))
    mb_renting_period3_end_date = fields.Date(string="Date fin période 3", default=lambda self: fields.Date.today().replace(month=8, day=31))
    mb_renting_period3_minimal_time_duration = fields.Integer(string="Durée minimale période 3", default=3)
    ...
    def get_minimal_rental_duration(self, rental_date):
        ...
        if self.mb_renting_period1_start_date <= date_to_check <= self.mb_renting_period1_end_date:
            duration = self.mb_renting_period1_minimal_time_duration
            unit = self.mb_renting_period1_minimal_time_unit
        elif self.mb_renting_period2_start_date <= date_to_check <= self.mb_renting_period2_end_date:
            duration = self.mb_renting_period2_minimal_time_duration
            unit = self.mb_renting_period2_minimal_time_unit
        elif self.mb_renting_period3_start_date <= date_to_check <= self.mb_renting_period3_end_date:
...
class ResConfigSettings(models.TransientModel):
    ...
    mb_renting_period1_start_date = fields.Date(
        related='company_id.mb_renting_period1_start_date', readonly=False, 
        string="Date de début - Basse saison")
    mb_renting_period1_end_date = fields.Date(
        related='company_id.mb_renting_period1_end_date', readonly=False,
        string="Date de fin - Basse saison")
    mb_renting_period1_minimal_time_duration = fields.Integer(
        related='company_id.mb_renting_period1_minimal_time_duration', readonly=False,
        string="Durée minimum - Basse saison")
    mb_renting_period1_minimal_time_unit = fields.Selection(
        related='company_id.mb_renting_period1_minimal_time_unit', readonly=False,
        string="Unité - Basse saison")
    
    # Période 2 (Moyenne saison)
    mb_renting_period2_start_date = fields.Date(
        related='company_id.mb_renting_period2_start_date', readonly=False,
        string="Date de début - Moyenne saison")
    mb_renting_period2_end_date = fields.Date(
        related='company_id.mb_renting_period2_end_date', readonly=False,
        string="Date de fin - Moyenne saison")
    mb_renting_period2_minimal_time_duration = fields.Integer(
        related='company_id.mb_renting_period2_minimal_time_duration', readonly=False,
        string="Durée minimum - Moyenne saison")
    mb_renting_period2_minimal_time_unit = fields.Selection(
        related='company_id.mb_renting_period2_minimal_time_unit', readonly=False,
        string="Unité - Moyenne saison")
    
    # Période 3 (Haute saison)
    mb_renting_period3_start_date = fields.Date(
        related='company_id.mb_renting_period3_start_date', readonly=False,
        string="Date de début - Haute saison")
    mb_renting_period3_end_date = fields.Date(
        related='company_id.mb_renting_period3_end_date', readonly=False,
        string="Date de fin - Haute saison")
    mb_renting_period3_minimal_time_duration = fields.Integer(
        related='company_id.mb_renting_period3_minimal_time_duration', readonly=False,
        string="Durée minimum - Haute saison")
    mb_renting_period3_minimal_time_unit = fields.Selection(
        related='company_id.mb_renting_period3_minimal_time_unit', readonly=False,
